...
import com.ilham.etumarketbyseller.databinding.FragmentNewPasswordAdminBinding
...
class NewPasswordAdminFragment : Fragment() {

    lateinit var binding : FragmentNewPasswordAdminBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentNewPasswordAdminBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnSave.setOnClickListener {
            ...
            userVm.responsenewpass.observe(viewLifecycleOwner){
                ...
                findNavController().navigate(R.id.action_newPasswordFragment_to_loginAdminFragment)
            }
        }
